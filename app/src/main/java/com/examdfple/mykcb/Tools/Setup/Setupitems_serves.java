...
public class Setupitems_serves {
    ...
    private LinearLayout lau = null;  // 展示布局
    private EditText ed ;
    ...
    public void Xuanseqi(SeekBar s1, SeekBar s2, SeekBar s3, SeekBar s4, LinearLayout lay1, String M_color, EditText edt){
        this.lau = lay1;
        this.ed = edt;
        // 设置默认颜色值
        SetM_Color(M_color,s1, s2, s3, s4);
    ...
    public void Logcol(){
        // 设置背景色
      this.lau.setBackgroundColor(Color.parseColor(getColor()));
    ...
    /**设置默认颜色值*/
    public void SetM_Color(String M_c,SeekBar s1, SeekBar s2, SeekBar s3, SeekBar s4){
        this.lau.setBackgroundColor(Color.parseColor(M_c));
       ...
       try{  A= colorParts.substring(6, 8);}catch (Exception e){ A = "00";}
        Log.d("SSSSSSSSSSSSS", String.valueOf(Integer.parseInt(A,16)));
